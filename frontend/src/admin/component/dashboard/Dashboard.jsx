...
const Dashboard = () => {
  ...
  return (
    <div className="p-8">
      ...
      {loading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 animate-pulse">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 h-32"
            />
          ))}
        </div>
      ) : error ? (
      ...
      {stats && (
        <div className="bg-linear-to-r from-[#1C4D8D] to-[#2d6ba3] rounded-2xl p-8 text-white mb-8">
          <h2 className="text-xl font-bold mb-6">Platform Impact</h2>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link
            to="/admin/members"
            className="flex items-center justify-center px-6 py-3 rounded-lg bg-blue-50 text-[#1C4D8D] font-semibold hover:bg-blue-100 transition-colors border border-blue-200"
          >
            View Members
          </Link>
          <Link
            to="/admin/businesses"
            className="flex items-center justify-center px-6 py-3 rounded-lg bg-amber-50 text-amber-700 font-semibold hover:bg-amber-100 transition-colors border border-amber-200"
          >
            View Businesses
          </Link>
          <Link
            to="/admin/approvals"
            className="flex items-center justify-center px-6 py-3 rounded-lg bg-purple-50 text-purple-700 font-semibold hover:bg-purple-100 transition-colors border border-purple-200"
          >
            View Pending
          </Link>
        </div>
