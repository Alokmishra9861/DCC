    ...
    <aside className="w-72 bg-white border-r border-gray-200 flex flex-col h-[calc(100vh-64px)] sticky top-16 hidden lg:flex">
      ...
      <div className="p-4 border-t border-gray-100">
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-slate-600 rounded-xl hover:bg-red-50 hover:text-red-600 w-full transition-colors group"
        >
