                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2 opacity-100 sm:opacity-60 sm:group-hover:opacity-100 transition-opacity">
                        ...
                        <button
                          ...
                          className="w-8 h-8 rounded-lg bg-blue-50 text-[#1C4D8D] border border-blue-200/60 flex items-center justify-center hover:bg-[#1C4D8D] hover:text-white hover:border-[#1C4D8D] transition-all"
                        >
                          <svg
                            className="w-4 h-4"
                            fill="none"
